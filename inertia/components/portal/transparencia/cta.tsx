    ...
    <PortalSection surface="muted" border="top">
      <div className="grid grid-cols-12 gap-5">
        ...
        >
          ...
          <h3 className="mt-4 text-balance font-serif text-4xl font-medium leading-tight tracking-tight">
            Faça um pedido pela{' '}
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -bottom-4 -right-2 select-none font-serif text-9xl font-medium leading-none text-primary-foreground/5"
          >
            LAI
          </div>
        </a>
